    ...
    public class CovidService
    {
        ...
        private async Task<IList<CovidData>> FetchConfirmedCasesFromJohnHopkins()
        {
            ...
            while (more)
            {
                ...
                var uri = string.Format(ARC_GIS_QUERY_URI, offset, RECORD_COUNT, DateTime.Now.Ticks);
